...
static int
lnav_clear_allblock(lua_State *L) {
    struct map *m = luaL_checkudata(L, 1, MT_NAME);
    int i;
...
static int
lnav_dump_connected(lua_State *L) {
    struct map *m = luaL_checkudata(L, 1, MT_NAME);
